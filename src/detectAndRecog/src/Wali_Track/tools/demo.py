...
parser.add_argument('--resume', default='/home/mahxn0/M_DeepLearning/object_track/SiamMask/experiments/siammask_sharp/SiamMask_VOT.pth', type=str, required=True,
                    metavar='PATH',help='path to latest checkpoint (default: none)')
parser.add_argument('--config', dest='config', default='config_davis.json/home/mahxn0/M_DeepLearning/object_track/SiamMask/experiments/siammask_sharp/config_vot.json',
    ...
    while True:
        ...
        if(cap.isOpened()):
            ...
            if track_flag:
                ...
                if f == 0:  # init
                    state = sm.track_init(x,y,w,h)
                elif f > 0:  # tracking
                    im=sm.track(im,state)[0]
                    key = cv2.waitKey(1)
                    if key > 0:
                        break
