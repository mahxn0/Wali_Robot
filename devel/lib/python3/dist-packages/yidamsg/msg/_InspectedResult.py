...
"""autogenerated by genpy from yidamsg/InspectedResult.msg. Do not edit."""
import sys
...
class InspectedResult(genpy.Message):
  _md5sum = "a5099b70cbd9d8bb23d365d2dd09bd90"
  _type = "yidamsg/InspectedResult"
...
bool success
"""
  __slots__ = ['camid','picid','x','y','z','equipimage','nameplates','equipid','result','success']
  _slot_types = ['int32','int32','float32','float32','float32','uint8[]','uint8[]','string','string','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InspectedResult, self).__init__(*args, **kwds)
