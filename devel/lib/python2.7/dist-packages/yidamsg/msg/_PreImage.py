...
"""autogenerated by genpy from yidamsg/PreImage.msg. Do not edit."""
import sys
...
class PreImage(genpy.Message):
  _md5sum = "e06bb60f0e1b2528085e8a03d7e758d8"
  _type = "yidamsg/PreImage"
...
string frame_id
"""
  __slots__ = ['camid','picid','image']
  _slot_types = ['int32','int32','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PreImage, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i3I().pack(_x.camid, _x.picid, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.camid, _x.picid, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_2i3I().unpack(str[start:end])
      start = end
      end += 4
