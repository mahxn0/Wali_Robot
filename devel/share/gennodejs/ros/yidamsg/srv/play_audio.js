...
class play_audioRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type play_audioRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type play_audioRequest
    let len;
    let data = new play_audioRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new play_audioRequest(null);
...
class play_audioResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type play_audioResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type play_audioResponse
    let len;
    let data = new play_audioResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new play_audioResponse(null);
...
module.exports = {
  Request: play_audioRequest,
  Response: play_audioResponse,
  md5sum() { return '1b4b6be30129215f962c2b865c54cf1f'; },
  datatype() { return 'yidamsg/play_audio'; }
};
