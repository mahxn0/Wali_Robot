...
;//! \htmlinclude LiveImage.msg.html

(cl:defclass <LiveImage> (roslisp-msg-protocol:ros-message)
  ((camid
    :reader camid
    :initarg :camid
    :type cl:integer
...
(cl:defclass LiveImage (<LiveImage>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LiveImage>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LiveImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yidamsg-msg:<LiveImage> is deprecated: use yidamsg-msg:LiveImage instead.")))

(cl:ensure-generic-function 'camid-val :lambda-list '(m))
(cl:defmethod camid-val ((m <LiveImage>))
...
(cl:defmethod picid-val ((m <LiveImage>))
...
(cl:defmethod x-val ((m <LiveImage>))
...
(cl:defmethod y-val ((m <LiveImage>))
...
(cl:defmethod z-val ((m <LiveImage>))
...
(cl:defmethod image-val ((m <LiveImage>))
...
(cl:defmethod len-val ((m <LiveImage>))
  ...
  (len m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LiveImage>) ostream)
  "Serializes a message object of type '<LiveImage>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LiveImage>) istream)
  "Deserializes a message object of type '<LiveImage>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LiveImage>)))
  "Returns string type for a message object of type '<LiveImage>"
  "yidamsg/LiveImage")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LiveImage)))
  "Returns string type for a message object of type 'LiveImage"
  "yidamsg/LiveImage")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LiveImage>)))
  "Returns md5sum for a message object of type '<LiveImage>"
  "e0feb94226f96ec22fa7dd4d4207a32a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LiveImage)))
  "Returns md5sum for a message object of type 'LiveImage"
  "e0feb94226f96ec22fa7dd4d4207a32a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LiveImage>)))
  "Returns full string definition for message of type '<LiveImage>"
  (cl:format cl:nil "int32 camid~%int32 picid~%float32 x~%float32 y~%float32 z~%uint8[] image~%int32 len~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LiveImage)))
  "Returns full string definition for message of type 'LiveImage"
  (cl:format cl:nil "int32 camid~%int32 picid~%float32 x~%float32 y~%float32 z~%uint8[] image~%int32 len~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LiveImage>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LiveImage>))
